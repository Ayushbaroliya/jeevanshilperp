...
- Name: dashboard.spec.js >> Dashboard Role-Based Access Control >> Administrator can see operations dashboard but NO payroll
- Location: e2e\dashboard.spec.js:21:3
...
Call log:
  - waiting for locator('#e2e-admin-login')
