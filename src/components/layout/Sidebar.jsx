  ...
  const navItems = [
    {
      ...
      show: permissions.viewDashboardStats || currentUser?.role === 'Administrator' || currentUser?.role === 'Principal' || currentUser?.role === 'Owner' || currentUser?.role === 'Accountant'
    },
    {
      id: 'teacher',
    ...
    },
    {
      ...
      label: 'Staff & Salary',
      icon: Briefcase,
      show: permissions.staffSalary || currentUser?.role === 'Administrator' || currentUser?.role === 'Principal' || currentUser?.role === 'Owner'
    },
    {
      id: 'settings',
      label: dict.schoolSettings || 'School Settings & Governance',
      icon: Settings,
      show: permissions.settings || currentUser?.role === 'Administrator' || currentUser?.role === 'Principal' || currentUser?.role === 'Owner'
    }
  ];
