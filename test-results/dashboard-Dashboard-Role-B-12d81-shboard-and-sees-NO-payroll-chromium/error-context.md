...
- Name: dashboard.spec.js >> Dashboard Role-Based Access Control >> Accountant defaults to Finance dashboard and sees NO payroll
...
Call log:
  - waiting for locator('#e2e-accountant-login')
